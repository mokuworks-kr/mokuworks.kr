  ...
  return (
    <section className="mx-auto max-w-page px-4 md:px-8 py-12">
      ...
      <input
        ...
        className="w-full bg-transparent text-ink border-b border-mist py-3 text-body placeholder:text-fog focus:outline-none focus:border-ink transition-colors"
      />
